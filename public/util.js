...
util.getSensation = function(pmv) {
    if (pmv < -2.5) return '<span>冷</span>';
    else if (pmv < -1.5) return '<span">凉</span>';
    else if (pmv < -0.5) return '<span>稍凉</span>';
    else if (pmv < 0.5) return '<span>中性</span>';
    else if (pmv < 1.5) return '<span>稍暖</span>';
    else if (pmv < 2.5) return '<span">暖</span>';
    else return '<span">热</span>';
};
